...
if __name__ == "__main__":
    ...
    parser.add_argument('--s3_bucket', required=True, help='S3 bucket to sync the output files')
    args = parser.parse_args()

    process_svs_files(args.input_dir, args.output_dir, args.temp_dir, args.log_file)

    # Sync the output files to the specified S3 bucket
    sync_to_s3(args.output_dir, args.s3_bucket)
